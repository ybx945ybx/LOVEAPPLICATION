...
////                    EventManager.ins().sendEvent(EventTag.ACCOUNT_RELOGOUT, 0, 0, "账号在别的设备登录");
////                } else if (error == EMError.USER_LOGIN_ANOTHER_DEVICE) {
////                    EventManager.ins().sendEvent(EventTag.ACCOUNT_RELOGOUT, 0, 0, "账号被移除");
...
//                        EventManager.ins().sendEvent(EventTag.CHAT_NOTIFY_MSG, 0, 0, message);
